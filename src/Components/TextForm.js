    ...
    <>
      <div className='container my-3' /*style={props.theme}*/>
        <div className="form-group" /*style={props.theme}*/>
          ...
          <button type="button" class={`btn btn-${props.theme.type} mt-3 mx-3`} onClick={handleCopy}>
      ...
      <div className='container my-3' style={props.theme}>
        ...
        <p>{Text.split(" ").length * 0.3} Seconds, {Text.split(" ").length * 0.005} Minuts to read</p>
        <h4>Preview</h4>
